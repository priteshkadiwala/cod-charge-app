...
function Extension() {
	...
	useEffect(() => {
		if (changingRef.current || !variantId || !chargeAmount) return;
	...
	}, [isCODSelected, hasCodLine, variantId, chargeAmount, applyCartLinesChange, codLine]);
	...
	return (
		<Banner status="info" title="COD Fee Applied">
			<Text>A COD fee of ₹{displayAmount} has been added to your order.</Text>
		</Banner>
	);
}
